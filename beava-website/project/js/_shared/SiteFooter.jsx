...
const SiteFooter = ({ maxWidth = 1200 }) => (
  <footer className="bv-site-footer" style={{ background: 'var(--bg-alt)', borderTop: '1px solid var(--border)', padding: '64px 24px 40px' }}>
    ...
    <div style={{ maxWidth, margin: '0 auto' }}>
      ...
      {/* LLM-agent affordance — site-wide. The plain-text SDK
          reference at /sdk/llms.txt concatenates all 12 SDK pages
          (now including Server configuration) without site chrome,
          generated by beava-website/scripts/build-llms-txt.mjs.
          Subdued styling: small, monospace eyebrow + sans body. The
          link is for non-human readers. */}
      <div className="bv-llm-footer" style={{
        ...
        <a href="/sdk/llms.txt" style={{
          ...
          fontSize: '0.95em',
        }}>/sdk/llms.txt</a>{' '}for the full plain-text SDK reference.
      </div>
    </div>
  </footer>
);
